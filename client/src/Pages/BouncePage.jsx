...
const BonusPage = () => {
  ...
  const handleDeposit = (e) => {
    ...
    navigate("/Deposite?trading=payment-page");
  };
  ...
  return (
    <div className="h-[80vh] overflow-auto">
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex items-center space-x-2 bg-[#3a4252] border border-[#4a5466] rounded text-white px-2">
                <input
                  ...
                  type="number"
                />
                <div className="text-white mr-2">USD</div>
              </div>

              {/* Predefined Amount Buttons */}
              <div className="flex items-center gap-2">
                <div className="flex space-x-3">
                  {[150, 200, 300, 500].map((value) => (
                    <button
                      key={value}
                      value={value}
      ...
      <div className="flex flex-col md:flex-row w-full bg-gray-900 text-white rounded overflow-hidden">

...
const SunPay = () => {
  ...
  const handleDeposit = async (e) => {
    e.preventDefault();
    await dispatch(RechargeSunPay({ amount: amount, type: "USDT" })).then(
      (res) => {
          ...
          <div className=" rounded">
            ...
            <div className="">
              <div className="">
                ...
                {message && (
                  <p
                    className={`mt-3 text-sm ${message === "Invalid promo code" ? "text-white" : "text-green-500"}  bg-[#1c1f2d]/20 p-2 rounded `}
                  >
                    {message}
                  </p>
                )}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      This address is for{" "}
                      <span className="font-semibold">UPI</span> transfers only.
                      Do not send smart contracts, TRX coins or any other
            ...
            {bonus > 0 && (
              <h3 className="text-end text-white font-semibold text-lg">
          ...
          <div className=" text-white p-2 md:p-6 max-w-2xl mx-auto text-sm">
            ...
            <div className="border-b border-gray-700 pb-3 mb-3">
              ...
              >
                ...
                Is there a minimum amount that I can deposit to my account at
                registration?
              </button>
              {open === "faq1" && (
                <div className="bg-[#2d2d3d] text-gray-300 mt-3 p-4 rounded text-sm">
                  The advantage of the Company’s trading platform is that you
                  don’t have to deposit large amounts to your account. You can
                  start trading by investing a small amount of money. The
                  minimum deposit is 1000 rupees.
                </div>
              )}
            </div>
            ...
            <div className="border-b border-gray-700 pb-3 mb-3">
              ...
              >
                ...
                Do I need to deposit the account of the trading platform and how
                often do I need to do this?
              </button>
              {open === "faq2" && (
                <div className="bg-[#2d2d3d] text-gray-300 mt-3 p-4 rounded text-sm">
                  To work with binary options you need to open an individual
                  account. To conclude real trades, you will certainly need to
                  make a deposit in the amount of options purchased.
                  <br />
                  You can start trading without cash, only using the company's
                  training account (demo account). Such an account is free of
                  charge and created to demonstrate the functioning of the
                  trading platform. With the help of such an account, you can
                  practice acquiring binary options, understand the basic
                  principles of trading, test various methods and strategies, or
                  evaluate the level of your intuition.
                </div>
              )}
            </div>
            ...
            <div className="border-b border-gray-700 pb-3 mb-3">
              ...
              {open === "faq3" && (
                <div className="bg-[#2d2d3d] text-gray-300 mt-3 p-4 rounded text-sm">
                  It is very easy to do. The procedure will take a couple of
                  minutes.
                  <br />
                  <ol>
                    <li>
                      ...
                      <br />
                      You can also deposit the account through your Personal
                      Account by clicking the "Deposit" button in the account
                      profile.
                    </li>
                    <li>
                      2) After it is necessary to choose a method of depositing
                      the account (the Company offers a lot of convenient
                      methods that are available to the Client and are displayed
                      in his individual account).
                    </li>
                    <li>
                      3) Next, indicate the currency in which the account will
                      be deposited, and accordingly the currency of the account
                      itself.
                    </li>
                    <li>4) Enter the amount of the deposit.</li>
                    <li>
                      5) Fill out the form by entering the requested payment
                      details.
                    </li>
            ...
            <div className="border-b border-gray-700 pb-3 mb-3">
              ...
              {open === "faq4" && (
                <div className="bg-[#2d2d3d] text-gray-300 mt-3 p-4 rounded text-sm">
                  ...
                  don’t have to deposit large amounts to your account. You can
                  start trading by investing a small amount of money. The
                  minimum deposit is 10 US dollars.
                </div>
              )}
            </div>
            ...
            <div>
              ...
              {open === "faq5" && (
                <div className="bg-[#2d2d3d] text-gray-300 mt-3 p-4 rounded text-sm">
                  No. The company does not charge any fee for either the deposit
                  or for the withdrawal operations. <br />
                  However, it is worth considering that payment systems can
                  charge their fee and use the internal currency conversion
                  rate.
                </div>
              )}
            </div>
